...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="font1/captureit2_regular_macroman/stylesheet.css" />
        <link rel="stylesheet" href="font1/captureit_regular_macroman/stylesheet.css" />
        <link rel="stylesheet" href="font2/impactlabel_regular_macroman/stylesheet.css" />
        <link rel="stylesheet" href="font2/impactlabelreversed_regular_macroman/stylesheet.css" />
    ...
    <body class="landing">
        ...
        <header id="header">
            <nav id="nav">
                <ul>
                    ...
                    <li><a href="http://www.lfc.cl/api#/SENIOR-DOMINGO">Liga</a></li>
                    <li><a href="">Contacto</a></li>
                    <li><a href="#" class="button ">Ingresar</a></li>
                </ul>
            </nav>
        </header>
        ...
        <section  id="banner" >
            ...
            <h2 style="font-family: 'impact_label_reversedregular' ">Con Lokura FC. </h2>

            <div class=" col-lg-1" style="background-image: url(Galeria/logo.jpg); 
